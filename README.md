...
the utilization of elements that make it easier for people to access and use your website. This can include scalability across different sized devices as well as making use of semantic tags so that a screen reader can better identify sections of your page for those who are impaired.

2. Talk about 3 different things you can do to ensure your website is accessible.

-make use of semantic tags so screen readers can better identify areas of the page.
-use responsive units for scalability so that the font will grow in size upon zooming in.
-utilize contrasting colors to facilitate ease on reading. Avoid Red and Green where possible as consideration to colorblindness.

3. How would you explain the concept of a variable to someone new to programming?

a variable is a place to store a small amount of information that you'll need to use later.

4. What is the purpose of using functions in code?

functions are used to house algorithms and other code that is used multiple times. You can call a funtion in code to refernce a specific function as opposed to having duplicate code which clogs up both readability and functionality.
